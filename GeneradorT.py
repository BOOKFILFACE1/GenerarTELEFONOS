...
print(custom_fig.renderText('numero Generator'))
time.sleep(5)
clear()

print('Por Favor selecciona una de las Listas ♥ : \n')
print('1 - Numero Generador de Auustralia')
print('2 - Numero Generador de Usa')
print('0 - Elimina el Programa')
print('--- CTRL + C deten el Generador---')
a = input('Tu eleccion : ')
